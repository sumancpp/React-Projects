...
const Navber = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed z-999 w-full px-20 py-8 flex justify-between items-center text-black mix-blend-difference"
    >
      ...
      <div className="flex gap-12">
        {links.map((item, index) => (
          <motion.div
            ...
            initial="initial"
            whileHover="hover"
            className={`relative ${index === 4 ? "ml-32" : ""}`}
          >
            <div className="relative h-6 overflow-hidden cursor-pointer">
              <motion.span
                variants={{
                  initial: { y: 0 },
                  hover: { y: "100%" }
              ...
              <motion.span
                ...
                transition={{ duration: 0.4 }}
                className="absolute left-0 top-0 block text-lg font-light"
              >
                {item}
              </motion.span>
            </div>
