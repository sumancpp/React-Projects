...
const Footer = () => {
  return (
    <>
    <div className='w-full  bg-white text-zinc-900 p-20 flex gap-5'>
      <div className='w-1/2 h-full tracking-tighter font-semibold flex flex-col justify-between'>
          <div className='heading'>
            <h1 className='text-[6vw] font-semibold uppercase leading-0 tracking-tighter'>Eye-</h1>
          <h1 className='text-[6vw] font-semibold uppercase leading-0 mt-22 tracking-tighter'>Opening</h1>
          </div>
          
      </div>
      <div className='w-1/2'>
        <h1 className='text-[6vw] font-bold uppercase leading-0 tracking-tighter'>presentations</h1>
        <div className='flex gap-10'>
            <div className='underline flex flex-col mt-[8vw]'>
            <a className='' href="">Instagram</a>
            <a className='' href="">Behance</a>
            <a className='' href="">Facebook</a>
            <a className='' href="">Linkdin</a>
            ...
            <div className='rightsidedet w-full ml-[9vw] mt-[15vw] underline'>
                 <div className='flex flex-col ml-[20vw] whitespace-nowrap mt-[7vw]'>
                    <a href="">Home</a>
                    <a href="">Services</a>
                    <a href="">Our work</a>
                    <a href="">About us</a>
    ...
    <div className='w-full h-[6vw] flex items-center justify-between px-15 bg-white'>
      <svg text="black" width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex justify-between w-1/2'>
            <p className='text-zinc-400'>&copy; ochi design 2026.Legal Terms</p>
            <p className='text-zinc-400'>Website by suman</p>
        </div>
    </div>
    </>
  )
